...
The second tab delimited dataset the students used comes from [a comparative analysis of mammal life histories](http://esapubs.org/archive/ecol/E084/093/).[^opendata]

```{r}
baser <- read.csv("http://esapubs.org/archive/ecol/E084/093/Mammal_lifehistories_v2.txt", sep="\t")
tidyv <- read_tsv("http://esapubs.org/archive/ecol/E084/093/Mammal_lifehistories_v2.txt")
```
...
I did run into problems when trying to use NSE in ggplot functions:
