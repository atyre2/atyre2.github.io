...
That's some crazy stuff! Depending on which other variables are in the model, the coefficients for $x_1$ and $x_2$ can even be negative, although those models have a very low weight. The coefficients for $x_3$ and $x_4$ (things grouse don't like) are positive in some of the top models. Using the common rule-of-thumb that I hate, there are 4 models with $\Delta AIC_c < 2$ and trying to explain why the coefficient of $x_4$ is positive would cause some degree of heartburn.
