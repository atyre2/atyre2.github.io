...
It is worth repeating this exercise for a range of sample sizes. Overall power was excellent for $N = 2m$. So I'll repeat the process for sample sizes from 10 up to $2m$. I'm fitting 6 coefficients, so anything less than 10 is, frankly, ridiculous. But let's see what we get.

```{r samplesizePower, cache = TRUE}
