...
```{r typeIIplot, echo = FALSE, caption = "Per capita rate of death due to competition and Type II predation curves. a = 0.1, h = 0.3, P = 1"}
a <- 0.1
h <- 0.3
P <- 1
d1 <- 0.05
...
```{r typeIIplot2, echo = FALSE, caption = "Per capita rates of birth and death. a = 0.1, h = 0.3, P = 1"}
